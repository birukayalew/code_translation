...
# target_code_type = "human_written"
...
total_category_counts, total_severity_counts = batch_runner("human_written", "visualizations/outputs/human_written")
...
plt.title("Clippy Warnings by Custom Category and Severity (Human Written)")
